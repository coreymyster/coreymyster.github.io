let projects = [
  {
    ...
    desc:
      "Note that this is a project that is currently under development for 2020 and is a work in progress. I am a big craft beer fan and there are quite a few beers that I store away in a cellar to age. I have a lot of beers cellared, and realized I needed a way to keep track of them all - hence this application. I am building this in ReactJS and have hosted this project through GitLab and have set up a CI/CD workflow through Amplify in AWS. For now the app uses dummy data but I will eventually connect a DB to store the data.",
